...
import nme.events.Event;class RendererEvent extends Event
{public static inline var INITIALISED : String = "initialised";public function new(type : String, bubbles : Bool = false, cancelable : Bool = false)
