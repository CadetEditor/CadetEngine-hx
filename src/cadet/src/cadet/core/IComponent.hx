...
import nme.events.IEventDispatcher;@:meta(Event(type="cadet.events.ComponentEvent",name="addedToParent"))
...
{
    var index(never, set) : Int;    var scene(never, set) : CadetScene;    var exportTemplateID(never, set) : String;
