...
class Equations
{
	...
	public static function solveEquation(A : Float, B : Float, C : Float, D : Float, E : Float) : Array<Dynamic>
	{
		var argsLength : Int = arguments["length"];
	...
	public static function solveLinearEquation(A : Float, B : Float) : Array<Dynamic>
	{
	...
	public static function solveQuadraticEquation(A : Float, B : Float, C : Float) : Array<Dynamic>
	{
		if (Math.abs(A) < PRECISION) {
	...
	public static function solveCubicEquation(A : Float, B : Float, C : Float, D : Float) : Array<Dynamic>
	{
		if (Math.abs(A) < PRECISION) {
	...
	public static function solveQuarticEquation(A : Float, B : Float, C : Float, D : Float, E : Float) : Array<Dynamic>
	{
		if (Math.abs(A) < PRECISION) {
	...
	private static function mathAtan2(dx : Float, dy : Float) : Float
	{
		var a : Float;
		if (dx == 0) {
			a = Math.PI / 2;
