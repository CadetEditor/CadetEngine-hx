...
import nme.display.BitmapData;class NullBitmap
{
    public static var instance(get, never) : BitmapData;
@:meta(Embed(source="NullBitmap.png"))
private static var NullBitmap : Class<Dynamic>;private static var _instance : BitmapData;private static function get_Instance() : BitmapData{if (_instance == null) {_instance = Type.createInstance(NullBitmap, []).bitmapData;
        }return _instance;
    }
