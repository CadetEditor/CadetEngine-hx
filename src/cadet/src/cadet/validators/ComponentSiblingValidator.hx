...
class ComponentSiblingValidator implements IComponentValidator
{
	private var maxSiblingsOfSameType : Int = -1;
	private var requiredSiblingTypes : Array<Dynamic>;
	
	public function new(maxSiblingsOfSameType : Int = -1, requiredSiblingTypes : Array<Dynamic> = null)
    {
	...
	public function validate(componentType : Class<Dynamic>, parent : IComponentContainer) : Bool
	{
		...
		for (requiredSiblingType in requiredSiblingTypes) {
