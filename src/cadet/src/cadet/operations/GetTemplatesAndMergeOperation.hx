...
class GetTemplatesAndMergeOperation extends UndoableCompoundOperation implements IAsynchronousOperation implements IUndoableOperation
{
	private var components : Array<Dynamic>;
	private var fileSystemProvider : IFileSystemProvider;
	private var domTable : Dynamic;
	
	public function new(components : Array<Dynamic>, fileSystemProvider : IFileSystemProvider, domTable : Dynamic = null)
    {
        super();
