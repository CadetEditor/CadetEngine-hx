...
class Box extends Sprite
{
	...
	public function new()
	{
		...
		renderer.viewportWidth = stage.stageWidth; renderer.viewportHeight = stage.stageHeight;
	...
	private function addRectangleEntity(x : Float, y : Float, width : Float, height : Float, rotation : Float, fixed : Bool = false) : ComponentContainer
	{
