...
class C2DTestsTransform05 extends Sprite
{
	...
	private function createRectangleEntity(parent : ComponentContainer, x : Float, y : Float, width : Float, height : Float, name : String = "Rectangle", lineColour : Int = 0xFFFFFF) : ComponentContainer
	{
