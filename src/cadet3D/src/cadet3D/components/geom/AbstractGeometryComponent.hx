...
import away3d.core.base.Geometry;import cadet.components.geom.IGeometry;import cadet.core.Component;class AbstractGeometryComponent extends Component implements IGeometry
{
    public var geometry(get, never) : Geometry;
  // Invalidation types;  private var GEOMETRY : String = "geometry";private var _geometry : Geometry;public function new()
    {
        super();_geometry = new Geometry();
    }private function get_Geometry() : Geometry{return _geometry;
    }
}