...
import away3d.core.base.Geometry;import cadet.core.Component;import nme.events.Event;class GeometryComponent extends AbstractGeometryComponent
{
...
private function set_Geometry(value : Geometry) : Geometry{if (value == _geometry)             return;_geometry = value || new Geometry();dispatchEvent(new Event(Event.CHANGE));
        return value;
    }
}