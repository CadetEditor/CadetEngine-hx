...
class MeshComponent extends ObjectContainer3DComponent
{
	...
	private function set_geometryComponent(value : AbstractGeometryComponent) : AbstractGeometryComponent
	{
		if (_geometryComponent == value) return;
		if (_geometryComponent != null) {
	...
	private function get_geometryComponent() : AbstractGeometryComponent
	{
