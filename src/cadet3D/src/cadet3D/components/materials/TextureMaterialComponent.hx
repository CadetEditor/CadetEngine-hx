...
class TextureMaterialComponent extends AbstractMaterialComponent
{
	...
	private var _envMapAlpha : Float = 1;
	...
	private function set_envMapAlpha(value : Float) : Float
	{
	...
	private function get_envMapAlpha() : Float
	{
		return _envMapAlpha;
	}
	...
	private function set_ambientTexture(value : AbstractTexture2DComponent) : AbstractTexture2DComponent
	{
	...
	private function get_ambientTexture() : AbstractTexture2DComponent
	{
	...
	private function set_diffuseTexture(value : AbstractTexture2DComponent) : AbstractTexture2DComponent
	{
	...
	private function get_diffuseTexture() : AbstractTexture2DComponent
	{
	...
	private function set_environmentMap(value : BitmapCubeTextureComponent) : BitmapCubeTextureComponent
	{
	...
	private function get_environmentMap() : BitmapCubeTextureComponent
	{
	...
	private function set_normalMap(value : AbstractTexture2DComponent) : AbstractTexture2DComponent
	{
		if (_normalMap != null) {
	...
	private function get_normalMap() : AbstractTexture2DComponent
	{
		return _normalMap;
	}
	...
	private function set_specularMap(value : AbstractTexture2DComponent) : AbstractTexture2DComponent
	{
	...
	private function get_specularMap() : AbstractTexture2DComponent
	{
		return _specularMap;
	}
