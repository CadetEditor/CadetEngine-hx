...
class AbstractMaterialComponent extends Component
{
	...
	private var _material : SinglePassMaterialBase;
	...
	private function get_material() : SinglePassMaterialBase
	{
		return _material;
	}  
	...
	private function set_depthCompareMode(value : String) : String
	{
		_material.depthCompareMode = value;
		return value;
	}
	
	private function get_depthCompareMode() : String
	{
