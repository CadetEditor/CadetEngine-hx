...
class SkyBoxMaterialComponent extends Component
{
	...
	private function get_material() : SkyBoxMaterial
	{
	...
	private function set_cubeTexture(value : BitmapCubeTextureComponent) : BitmapCubeTextureComponent
	{
		if (_bmpCubeTextureComponent != null) {
	...
	private function get_cubeTexture() : BitmapCubeTextureComponent
	{
