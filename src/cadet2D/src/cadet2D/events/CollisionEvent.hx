...
class CollisionEvent extends Event
{
	...
	public function new(type : String, objectA : ICollisionShape, objectB : ICollisionShape)
    {
	...
	private function get_ObjectA() : ICollisionShape
	{
		return _objectA;
    }
	
	private function get_ObjectB() : ICollisionShape
	{
		return _objectB;
    }
}