...
import cadet.core.CadetScene;import cadet.core.Component;import cadet.core.IComponentContainer;import cadet.util.ComponentReferenceUtil;import cadet.util.ComponentUtil;import cadet2d.components.transforms.Transform2D;import nme.events.Event;@:meta(Event(type="cadet.events.CollisionEvent",name="collision"))
class CollisionShape extends Component implements ICollisionShape
{
    public var transform(get, never) : Transform2D;
public var _transform : Transform2D;public function new()
    {
        super();
    }override private function addedToScene() : Void{addSiblingReference(Transform2D, "_transform");
