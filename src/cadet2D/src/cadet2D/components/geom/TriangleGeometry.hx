...
class TriangleGeometry extends PolygonGeometry
{
	...
	private var _flipVertical : Bool = false;
	private var _tipRatio : Float;
	...
	private function get_FlipVertical() : Bool
	{
		return _flipVertical;
    }
	
	@:meta(Serializable())
	private function set_TipRatio(value : Float) : Float
	{
		_tipRatio = value;
		invalidate("geometry");
        return value;
	...
	private function get_TipRatio() : Float
	{
		return _tipRatio;
    }
