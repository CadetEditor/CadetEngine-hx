...
class RectangleGeometry extends PolygonGeometry
{
    public var width(get, set) : Float;
    public var height(get, set) : Float;
	private inline var SIZE : String = "size";
	private var _width : Float;
	private var _height : Float;
	private var corners : Array<Dynamic>;
	...
	private function getCornersBy(filterFunc : Function) : Array<Dynamic>
	{
	...
	private function validateSize() : Void
	{
		...
		if (regular) {
			...
			var xCorners : Array<Dynamic> = getCornersBy(filterByX);
			var yCorners : Array<Dynamic> = getCornersBy(filterByY);
	...
	override public function centre(transform : Transform2D, useCentroid : Bool = false) : Void
	{  
		//validateNow();  
