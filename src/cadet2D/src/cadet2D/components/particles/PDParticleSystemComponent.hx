...
class PDParticleSystemComponent extends Component implements IInitialisableComponent implements IAnimatable
{
	...
	// Constants  
	private inline var TRANSFORM : String = "transform";
	private inline var RESOURCES : String = "resources";
	private inline var DISPLAY : String = "display";
	
	@:meta(Embed(source="NullParticle.png"))
	private static var NullParticle : Class<Dynamic>;
	...
	private var _addedToJuggler : Bool;
	...
	private var _emitterTypeInt : Int = 0;  
	
	// Start Color  
	private var _startColor : Int = 0x0000FF;
	private var _startColorAlpha : Float = 1;
	private var _startColorVariance : Int = 0;
	private var _startColorVarAlpha : Float = 1;
	...
	// End Color  
	private var _endColor : Int = 0x00FFFF;
	private var _endColorAlpha : Float = 0;
	private var _endColorVariance : Int = 0;
	private var _endColorVarAlpha : Int = 0;
	...
	private var _emitterX : Float = 0;
	private var _emitterY : Float = 0;
	private var _emitterXVariance : Float = 0;
	private var _emitterYVariance : Float = 0;
	...
	private var _maxNumParticles : Int = 128;
	private var _lifespan : Float = 0.4;
	private var _lifespanVariance : Float = 0;
	private var _emissionRate : Float = _maxNumParticles / _lifespan;
	private var _startSize : Float = 50;
	private var _startSizeVariance : Float = 0;
	private var _endSize : Float = 10;
	private var _endSizeVariance : Float = 0;
	private var _speed : Float = 800;
	private var _speedVariance : Float = 0;
	private var _gravityX : Float = 0;
	private var _gravityY : Float = 0;
	private var _radialAcceleration : Float = 0;
	private var _radialAccelVar : Float = 0;
	private var _tangentialAccel : Float = 0;
	private var _tangentialAccelVar : Float = 0;
	private var _maxRadius : Float = 100;
	private var _maxRadiusVariance : Float = 0;
	private var _minRadius : Float = 20;  
	...
	private var _emitAngle : Float = 0;
	private var _emitAngleVariance : Float = 0;
	private var _startRotation : Float = 0;
	private var _startRotationVar : Float = 0;
	private var _endRotation : Float = 0;
	private var _endRotationVar : Float = 0;
	private var _rotatePerSecond : Float = 720;
	private var _rotatePerSecondVar : Float = 0;
	private var _previewAnimation : Bool;  
	
	// IRenderable values  
	private var _displayObject : Sprite;
	private var _indexStr : String;
	
	public function new(config : FastXML = null, textureComponent : TextureComponent = null, name : String = "PDParticleSystemComponent")
    {
		super(name);
		_xml = config;
		_texture = texture;
	...
	override private function addedToScene() : Void
	{
		...
		if (renderer != null && renderer.initialised) {
	...
	private function createDefaultTexture() : Void
	{
		...
		var instance : BitmapData = Type.createInstance(NullParticle, []).bitmapData;
	...
	private function validateResources() : Void
	{
		var config : FastXML;
		var texture : Texture;
		if (_xml != null) config = _xml;
        else config = serialise();
		if (_texture != null && _texture.texture) texture = _texture.texture;
	...
	private function set_SerializedMatrix(value : String) : String
	{
	...
	private function get_SerializedMatrix() : String
	{
		var m : Matrix = matrix;
	...
	private function get_Renderer() : Renderer2D
	{
		return _renderer;
    }
	
	private function set_Renderer(value : Renderer2D) : Renderer2D
	{
		if (_renderer != null) {
	...
	private function get_PreviewAnimation() : Bool
	{
		return _previewAnimation;
    }
	
	private function set_PreviewAnimation(value : Bool) : Bool
	{
	...
	private function get_EmitterType() : String
	{
		return _emitterType;
    }
	
	private function set_EmitterType(value : String) : String
	{
		_emitterType = value;
		invalidate(DISPLAY);
        return value;
	...
	private function get_EmitterTypeInt() : Int
	{
		var intType : Int = 0;
	...
	private function get_StartColorAlpha() : Float
	{
		return _startColorAlpha;
    }
	
	private function set_StartColorAlpha(value : Float) : Float
	{
	...
	private function get_StartColorVariance() : Int
	{
		return _startColorVariance;
    }
	
	private function set_StartColorVariance(value : Int) : Int
	{
	...
	private function get_StartColorVarAlpha() : Float
	{
		return _startColorVarAlpha;
    }
	
	private function set_StartColorVarAlpha(value : Float) : Float
	{
	...
	private function get_EndColorAlpha() : Float
	{
		return _endColorAlpha;
    }
	
	private function set_EndColorAlpha(value : Float) : Float
	{
	...
	private function get_EndColorVariance() : Int
	{
		return _endColorVariance;
    }
	
	private function set_EndColorVariance(value : Int) : Int
	{
	...
	private function get_EndColorVarAlpha() : Float
	{
		return _endColorVarAlpha;
    }
	
	private function set_EndColorVarAlpha(value : Float) : Float
	{
	...
	private function get_BlendFactorDest() : String
	{
		return _blendFactorDest;
    }
	
	private function set_BlendFactorDest(value : String) : String
	{
	...
	private function get_StartRotationVar() : Float
	{
		return _startRotationVar;
    }
	
	private function set_StartRotationVar(value : Float) : Float
	{
	...
	private function get_EndRotationVar() : Float
	{
		return _endRotationVar;
    }
	
	private function set_EndRotationVar(value : Float) : Float
	{
	...
	private function get_RadialAccelVar() : Float
	{
		return _radialAccelVar;
    }
	
	private function set_RadialAccelVar(value : Float) : Float
	{
	...
	private function get_TangentialAccel() : Float
	{
		return _tangentialAccel;
    }
	
	private function set_TangentialAccel(value : Float) : Float
	{
	...
	private function get_TangentialAccelVar() : Float
	{
		return _tangentialAccelVar;
    }
	
	private function set_TangentialAccelVar(value : Float) : Float
	{
	...
	private function get_RotatePerSecondVar() : Float
	{
		return _rotatePerSecondVar;
    }
	
	private function set_RotatePerSecondVar(value : Float) : Float
	{
	...
	public function serialise() : FastXML
	{  
			// Note: XML Angles are stored in degrees  
			var defaultXML : FastXML = FastXML.parse("<particleEmitterConfig>
