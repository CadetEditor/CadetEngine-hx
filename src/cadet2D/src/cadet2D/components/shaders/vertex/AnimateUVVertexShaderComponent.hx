...
class AnimateUVVertexShaderComponent extends Component implements IShaderComponent
{
	...
	private var _uSpeed : Float;
	private var _vSpeed : Float;
	
	public function new(name : String = "AnimateUVVertexShaderComponent")
    {
		super(name);
	...
	private function get_USpeed() : Float
	{
		return _uSpeed;
    }
	
	private function set_USpeed(value : Float) : Float
	{
		_uSpeed = value;
		invalidate(VALUES);
        return value;
	...
	private function set_VSpeed(value : Float) : Float
	{
		_vSpeed = value;
		invalidate(VALUES);
        return value;
