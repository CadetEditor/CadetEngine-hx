...
class TextureComponent extends Component
{
	...
	public function new(name : String = "TextureComponent")
    {
		super(name);
    }
	...
	{
		var textureValidated : Bool = true;
	...
	private function validateTexture() : Bool
	{
		if (_bitmapData != null && Starling.context) {  
