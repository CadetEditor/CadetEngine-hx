...
@:meta(CadetEditor(transformable="false"))
class ConnectionSkin extends AbstractSkin2D
{
	...
	public function new(lineThickness : Float = 1, lineColor : Int = 0xFFFFFF, lineAlpha : Float = 0.5, width : Float = 10, radius : Float = 10)
    {
        super();
		name = "ConnectionSkin";
