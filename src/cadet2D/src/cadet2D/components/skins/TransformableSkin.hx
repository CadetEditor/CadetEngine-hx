...
class TransformableSkin extends AbstractSkin2D implements ITransform2D
{
	...
	@:meta(Serializable())
	private function set_InternalTransform(value : Transform2D) : Transform2D
	{
		...
		if (_internalTransform != null) {
			if (_transform2D == null) _internalTransform.addEventListener(ValidationEvent.INVALIDATE, onInternalTransformInvalidated);
			if (parentComponent != null) {
				var parentTransform : Transform2D = Transform2D.findParentTransform(parentComponent.parentComponent);
				_internalTransform.setupParentTransform(parentTransform);
            }
        }
        return value;
    }
	
	private function get_InternalTransform() : Transform2D
	{
		return _internalTransform;
    }  
	...
	{
		if (_transform2D != null) _transform2D.x = value
        else _internalTransform.x = value;
	...
	{
		return _transform2D != (null) ? _transform2D.x : _internalTransform.x;
    }
	
	@:meta(Inspectable(priority="51"))
	private function set_Y(value : Float) : Float
	{
		if (_transform2D != null) _transform2D.y = value
        else _internalTransform.y = value;
		invalidate(TRANSFORM);
        return value;
    }
	...
	{
		return _transform2D != (null) ? _transform2D.y : _internalTransform.y;
    }
	
	@:meta(Inspectable(priority="52"))
	private function set_ScaleX(value : Float) : Float
	{
		if (_transform2D != null) _transform2D.scaleX = value;
        else _internalTransform.scaleX = value;
		invalidate(TRANSFORM);
        return value;
    }
	...
	{
		return _transform2D != (null) ? _transform2D.scaleX : _internalTransform.scaleX;
    }
	
	@:meta(Inspectable(priority="53"))
	private function set_ScaleY(value : Float) : Float
	{
		if (_transform2D != null) _transform2D.scaleY = value;
        else _internalTransform.scaleY = value;
		invalidate(TRANSFORM);
        return value;
    }
	...
	{
		return _transform2D != (null) ? _transform2D.scaleY : _internalTransform.scaleY;
    }
	
	@:meta(Inspectable(priority="54",editor="Slider",min="0",max="360",snapInterval="1"))
	private function set_Rotation(value : Float) : Float
	{
		if (_transform2D != null) _transform2D.rotation = value;
        else _internalTransform.rotation = value;
		invalidate(TRANSFORM);
        return value;
    }
	...
	{
		return _transform2D != (null) ? _transform2D.rotation : _internalTransform.rotation;
    }
	
	private function set_Matrix(value : Matrix) : Matrix
	{
		if (_transform2D != null) _transform2D.matrix = value;
        else _internalTransform.matrix = value;
		invalidate(TRANSFORM);
        return value;
    }
	...
	{
		return _transform2D != (null) ? _transform2D.matrix : _internalTransform.matrix;
    }
	
	private function get_GlobalMatrix() : Matrix
	{
		return _transform2D != (null) ? _transform2D.globalMatrix : _internalTransform.globalMatrix;
    }
	
	private function get_ParentTransform() : ITransform2D
	{
		return _transform2D != (null) ? _transform2D.parentTransform : _internalTransform.parentTransform;
    }
	
	private function set_ParentTransform(value : ITransform2D) : ITransform2D
	{
	...
	{
		var m : Matrix = matrix;return m.a + "," + m.b + "," + m.c + "," + m.d + "," + m.tx + "," + m.ty;
    }  
	
	// -------------------------------------------------------------------------------------  
	
	@:meta(Serializable())
	override private function set_Transform2D(value : Transform2D) : Transform2D
	{
	...
	{
		if (internalTransform == null) internalTransform = new Transform2D();
	...
	override private function validateTransform() : Void
	{
		if (_transform2D != null) {
	...
	private function onInternalTransformInvalidated(event : ValidationEvent) : Void
	{
		invalidate(TRANSFORM);
    }
}