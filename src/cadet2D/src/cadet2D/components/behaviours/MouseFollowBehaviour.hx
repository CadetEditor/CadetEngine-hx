...
class MouseFollowBehaviour extends Component implements ISteppableComponent
{
	...
	public static inline var CONSTRAIN_X : String = "x";
	public static inline var CONSTRAIN_Y : String = "y";
	...
	{
		if (transform == null || renderer == null) return;
	...
	private function set_Constrain(value : String) : String
	{
		_constrain = value;
        return value;
    }
	
	private function get_Constrain() : String
	{
		return _constrain;
    }
	...
	private function touchEventHandler(event : TouchEvent) : Void
	{
		...
		var dispObj : DisplayObject = cast((_renderer.viewport.stage), DisplayObject);
