...
class PrismaticJointBehaviour extends Component implements IJoint
{
	...
	private var _lowerLimit : Float = 0;
	private var _upperLimit : Float = 10;
	private var _enableLimit : Bool = true;
	private var _enableMotor : Bool = false;
	private var _maxMotorForce : Float = 1;
	private var _motorSpeed : Float = 1;
	private var _autoCalculateLimits : Bool = true;
	private var _collideConnected : Bool = true;
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_MaxMotorForce(value : Float) : Float
	{
		_maxMotorForce = value;
		if (joint != null) joint.SetMaxMotorForce(_maxMotorForce);
        else invalidate(JOINT);
        return value;
    }
	
	private function get_MaxMotorForce() : Float
	{
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_MotorSpeed(value : Float) : Float
	{
		_motorSpeed = value;
		if (joint != null) joint.SetMotorSpeed(_motorSpeed);
        else invalidate(JOINT);
        return value;
    }
	
	private function get_MotorSpeed() : Float
	{
		return _motorSpeed;
    }
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_LowerLimit(value : Float) : Float
	{
		_lowerLimit = value;
		if (autoCalculateLimits) return;  // Ignore change if limits are auto-calculated  
		if (joint != null) joint.SetLimits(_lowerLimit, _upperLimit);
        else invalidate(JOINT);
        return value;
    }
	
	private function get_LowerLimit() : Float
	{
		return _lowerLimit;
    }
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_UpperLimit(value : Float) : Float
	{
		_upperLimit = value;
		if (autoCalculateLimits) return;  // Ignore change if limits are auto-calculated  
		if (joint != null) joint.SetLimits(_lowerLimit, _upperLimit);
	...
	private function get_UpperLimit() : Float
	{
		return _upperLimit;
    }
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_EnableLimit(value : Bool) : Bool
	{
		_enableLimit = value;
		if (joint != null) joint.EnableLimit(_enableLimit);
        else invalidate(JOINT);
        return value;
    }
	
	private function get_EnableLimit() : Bool
	{
		return _enableLimit;
    }
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_EnableMotor(value : Bool) : Bool
	{
		_enableMotor = value;
		if (joint != null) joint.EnableMotor(_enableMotor);
        else invalidate(JOINT);
        return value;
    }
	
	private function get_EnableMotor() : Bool
	{
		return _enableMotor;
    }
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_CollideConnected(value : Bool) : Bool
	{
	...
	private function get_CollideConnected() : Bool
	{
	...
	@:meta(Serializable())
	@:meta(Inspectable())
	private function set_AutoCalculateLimits(value : Bool) : Bool
	{
	...
	private function get_AutoCalculateLimits() : Bool
	{
		return _autoCalculateLimits;
    }
