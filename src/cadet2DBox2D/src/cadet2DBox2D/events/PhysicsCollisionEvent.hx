...
class PhysicsCollisionEvent extends Event
{
	public static inline var COLLISION : String = "collision";
	...
	public var normalImpulse : Float;  // In newtons  
	public var tangentImpulse : Float;  // In newtons  
	
	public function new(type : String, behaviourA : RigidBodyBehaviour, behaviourB : RigidBodyBehaviour, position : Point, normal : Point, normalImpulse : Float, tangentImpulse : Float)
    {
		super(type);
