...
import nme.events.Event;class RigidBodyBehaviourEvent extends Event
{public static inline var DESTROY_RIGID_BODY : String = "destroyRigidBody";public function new(type : String)
    {super(type);
    }
}